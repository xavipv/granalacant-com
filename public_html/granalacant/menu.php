...
<nav class="navbar navbar-toggleable-md navbar-light bg-faded">
    ...
    <div class="collapse navbar-collapse" id="menuprincipal">
        <ul class="nav nav-pills mr-auto">
            <li class="nav-item dropdown <?php echo $activo[1]; ?>">
            ...
            <li class="nav-item dropdown <?php echo $activo[2]; ?>">
                <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">Apartamentos</a>
                <div class="dropdown-menu">
            ...
            <li class="nav-item dropdown <?php echo $activo[3]; ?>">
                <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">Propietarios</a>
                <div class="dropdown-menu">
            ...
            <li class="nav-item dropdown <?php echo $activo[4]; ?>">
                <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">Juntas</a>
                <div class="dropdown-menu">
            ...
            <li class="nav-item dropdown <?php echo $activo[5]; ?>">
                <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">Actas</a>
                <div class="dropdown-menu">
            ...
            <li class="nav-item dropdown <?php echo $activo[6]; ?>">
                <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">Otros</a>
                <div class="dropdown-menu">
